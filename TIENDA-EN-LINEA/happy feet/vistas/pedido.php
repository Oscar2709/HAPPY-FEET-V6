...
if(isset($_POST['search'])){
    echo "llegue";
    $query2="select * from pedido where entrega_producto like '%$obj->entrega_producto%' limit $desde,$maximoRegistros";
...
<body>
    <div class="container shadow p-3 mb-5 bg-body rounded " >
        <h2><i class="fa fa-shopping-cart fa-2x" aria-hidden="true"></i> Pedido</h2>
        <form action="" name="clientes" method="POST">
            ...
            <table class="table">
                ...
                <div class="container-fluid">
                    <form class="d-flex" role="search">
                        <input class="form-control me-2" type="search" placeholder="Digite el Nombre o Código del Producto" aria-label="Search">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-sm shadow p-3 mb-5 bg-body rounded">
                    <thead>
                        <tr>
                            <td colspan="8" class="p-3 mb-2 bg-primary text-white"><h5>Detalle</h5></td>
                        </tr>
                    </thead> 
                    <tbody >
